...
public class UserSS implements UserDetails {
    ...
    public boolean hasRole(Perfil perfil) {
        return getAuthorities().contains(new SimpleGrantedAuthority(perfil.getDescricao())); // verifica se o role enviado como parâmetro existe na lista de authorities do user
    }
}
